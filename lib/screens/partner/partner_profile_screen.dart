...
class _PartnerProfileScreenState extends State<PartnerProfileScreen> {
  ...
  late List<Map<String, String>> _teamMembers;
  ...
  void _loadProfileData() {
    ...
    _teamMembers = List.from(data.teamMembers);
  }
  ...
  Widget _buildDocumentCard(String title, IconData icon, bool isVerified, String status) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(12),
        border: Border.all(color: isVerified ? const Color(0xFF4CAF50).withOpacity(0.3) : const Color(0xFFE8ECF4)),
      ),
      child: Column(
        children: [
          Stack(
            children: [
              Container(
                ...
                height: 44,
                decoration: BoxDecoration(
                  color: isVerified ? const Color(0xFF4CAF50).withOpacity(0.1) : const Color(0xFFE8ECF4),
                  borderRadius: BorderRadius.circular(12),
                ),
