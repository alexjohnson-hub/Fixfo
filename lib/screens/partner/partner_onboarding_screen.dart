...
class _PartnerOnboardingScreenState extends State<PartnerOnboardingScreen> {
  ...
  List<Map<String, String>> _teamMembers = []; // Now stores full contact info
  ...
  final List<Map<String, dynamic>> _paymentMethods = [
    {'name': 'Google Pay', 'icon': Icons.g_mobiledata, 'color': 0xFF4285F4},
    {'name': 'PhonePe', 'icon': Icons.phone_android, 'color': 0xFF5F259F},
    {'name': 'Paytm', 'icon': Icons.account_balance_wallet, 'color': 0xFF00BAF2},
    {'name': 'Razorpay', 'icon': Icons.payment, 'color': 0xFF072654},
    {'name': 'Bank Transfer', 'icon': Icons.account_balance, 'color': 0xFF4CAF50},
  ];
  ...
  Widget _buildBusinessTypeCard(String type, IconData icon, String subtitle) {
    ...
    return GestureDetector(
      ...
      child: Container(
        padding: const EdgeInsets.all(20),
        decoration: BoxDecoration(
          color: isSelected ? const Color(0xFF3366FF).withOpacity(0.1) : Colors.white,
          borderRadius: BorderRadius.circular(16),
          border: Border.all(
              ...
              children: [
                ...
                SliderTheme(
                  data: SliderTheme.of(context).copyWith(
                    ...
                    overlayColor: const Color(0xFF3366FF).withOpacity(0.2),
                  ),
                  child: Slider(
